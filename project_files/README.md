...
- 价格专题：[机器人整机价格、成本与未来三年走势分析](reports/competition/06_robot_pricing_cost_trend.md)
- 零售门店落地分析：[场景报告：零售门店与机器人落地分析](reports/scenarios/04_retail.md)
- 端到端模型科普：[中国具身智能机器人端到端模型进展](reports/basics/06_end_to_end_model_progress.md)
...
3. 阅读中国竞争格局、海外标杆对照、公司分层矩阵和整机价格专题。
...
- `data/`：结构化数据表，包括公司库、产品库、整机价格库、落地案例库、融资事件库和场景成熟度库。
